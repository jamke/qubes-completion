...
@test "Test 001. qubesctl: qubesctl -" {
    EXPECTED_COMPREPLY=([0]="--help" [1]="-h" [2]="--show-output" [3]="--force-color" [4]="--skip-dom0" [5]="--max-concurrency" [6]="--templates" [7]="--standalones" [8]="--app" [9]="--skip-top-check" [10]="--sync-extmods" [11]="--targets" [12]="--all")
    test_wrapper 'qubesctl -'
}

@test "Test 002. qubesctl: qubesctl --" {
    EXPECTED_COMPREPLY=([0]="--help" [1]="--show-output" [2]="--force-color" [3]="--skip-dom0" [4]="--max-concurrency" [5]="--templates" [6]="--standalones" [7]="--app" [8]="--skip-top-check" [9]="--sync-extmods" [10]="--targets" [11]="--all")
    test_wrapper 'qubesctl --'
}
